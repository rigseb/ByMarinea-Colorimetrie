...
/* ✅ Têtes de chapitre premium écran + PDF */
const chapterTitleStyle = {
  ...
  paddingBottom: 8,
  borderBottom: "1px solid rgba(201, 161, 74, 0.35)",
};

/* ✅ Variante PDF légèrement optimisée pour impression */
const pdfChapterTitleStyle = {
  marginTop: 0,
  marginBottom: 18,
  color: "#C9A14A",
  fontSize: 24,
      ...
      <div style={pageContainerStyle}>
        ...
        {tab === "diagnostic" && (
          <div className="screen-only" style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div style={cardStyle}>
              <h2 style={chapterTitleStyle}>Observation initiale</h2>
            ...
            {Object.entries(groupedTests).map(([section, tests]) => (
              <div key={section} style={cardStyle}>
                <h2 style={chapterTitleStyle}>{section}</h2>
                {tests.map((test) => (
        ...
        <div id="pdf-print" className="print-only">
          ...
          <div className="print-section">
            ...
            <div style={cardStyle}>
              <h3 style={pdfChapterTitleStyle}>Observation initiale</h3>
              {OBSERVATION_QUESTIONS.map((q) => {
            ...
            {Object.entries(groupedTests).map(([section, tests]) => (
              <div key={section} style={cardStyle}>
                <h3 style={pdfChapterTitleStyle}>{section}</h3>
                {tests.map((test) => (
